...
total_used_space = top_dir.calc_dir_size()
...
#diskspace available 70,000,000
#unused space of 30,000,000

remaining_space = 70000000 - total_used_space

minimum_space = 30000000 - remaining_space 

top_dir.dir_size_is_less_than(remaining_space,sizes)
...
for size in sizes:
    if(size < minimum_space):
        continue
    print("Minimum required: %s" % minimum_space)
    print("directory to delete: %s" % size)
    break
